...
@Service
public class AAATextContrastChecker implements IIssueChecker {

    private static final IssueType ISSUE_TYPE = IssueType.TEXT_CONTRAST_VIOLATION_AAA;
    private static final double MINIMUM_CONTRAST_RATIO = 7;
